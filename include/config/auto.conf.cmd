...
ifneq "$(CC)" "./toolchain/android_prebuilts_clang_host_linux-x86_clang-5484270-9.0/bin/clang"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "./toolchain/aarch64-linux-android-4.9/bin/aarch64-linux-android-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "./toolchain/aarch64-linux-android-4.9/bin/aarch64-linux-android-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "./toolchain/aarch64-linux-android-4.9/bin/aarch64-linux-android-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(CLANG_FLAGS)" "--target=aarch64-linux-gnu --prefix=./toolchain/aarch64-linux-android-4.9/bin/ --gcc-toolchain=/home/kamil/Pulpit/a127f-T-u8/toolchain/aarch64-linux-android-4.9 -no-integrated-as -Werror=unknown-warning-option"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
